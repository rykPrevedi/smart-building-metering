...
public class CoapObservingClientProcess {
    ...
    public static void main(String[] args) {
        ...
        //String targetCoapResourceURL = "coap://127.0.0.1:5683/water";

        String targetCoapResourceURL = "coap://192.168.10.43:5783/water-provider/H2O";

        //String targetCoapResourceURL = "coap://192.168.10.43:5783/energy-provider/EN";

        //String targetCoapResourceURL = "coap://192.168.10.43:5783/gas-provider/gas";

        //String targetCoapResourceURL = "coap://192.168.10.43:5783/gas-provider/parameter";
